                                            ...
                                            <div class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                ...
                                                <div class="flex items-start gap-2 mb-1">
                                                    ...
                                                    <button 
                                                        ...
                                                        class="w-5 h-5 flex-shrink-0 flex items-center justify-center bg-red-100 dark:bg-red-900 text-red-600 dark:text-red-400 rounded hover:bg-red-200 dark:hover:bg-red-800 transition-colors duration-150 text-sm font-bold"
                                                        title="Hapus item"
                                                    >
                                                        ×
                                                    </button>
                            ...
                            <div class="flex gap-2 mb-3 overflow-x-auto pb-1">
                                @foreach($photos as $index => $photo)
                                    <button 
                                        ...
                                        class="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0 border-2 {{ $selectedPhotoIndex === $index ? 'border-primary-500 dark:border-primary-400' : 'border-gray-200 dark:border-gray-600' }} hover:border-primary-400 dark:hover:border-primary-500 transition-colors duration-150"
                                    >
